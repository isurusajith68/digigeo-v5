...
const AccordionItemWithEyeWithLockVisibility = ({ title, children, onClick, eyeState,onLockClick,lockState,visibilityState }) => {
...
export default AccordionItemWithEyeWithLockVisibility;
